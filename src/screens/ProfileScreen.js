...
export default function ProfileScreen({ navigation }) {
  ...
  // Valor animado para o efeito de slide
  const slideAnim = useRef(new Animated.Value(-150)).current; // Começa fora da tela
  ...
  const handleLogout = () => {
    // Aqui você pode adicionar a lógica para limpar as credenciais e navegar para a tela de login
    console.log('Logout realizado'); // Substitua isso pela lógica de logout real
